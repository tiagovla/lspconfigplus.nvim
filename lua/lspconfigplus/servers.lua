...
servers["cmake"] = {
    ...
    executable = utils.install_path("cmake") .. "/venv/bin/cmake-language-server",
}
servers["dockerls"] = {
    script_path = "servers/dockerls.sh",
    executable = utils.install_path("dockerls") .. "/node_modules/.bin/docker-langserver",
}
servers["clangd"] = {
...
servers["pyright"] = {
    ...
    executable = utils.install_path("pyright") .. "/node_modules/.bin/pyright-langserver",
}
servers["tsserver"] = {
    script_path = "servers/tsserver.sh",
    executable = utils.install_path("tsserver") .. "/node_modules/.bin/typescript-language-server",
}
servers["sumneko_lua"] = {
    script_path = "servers/sumneko_lua.sh",
    executable = utils.install_path("sumneko_lua") .. "/sumneko-lua-language-server",
}
servers["texlab"] = {
...
servers["vimls"] = {
    ...
    executable = utils.install_path("vimls") .. "/node_modules/.bin/vim-language-server",
}
servers["bashls"] = {
    script_path = "servers/bashls.sh",
    executable = utils.install_path("bashls") .. "/node_modules/.bin/bash-language-server",
}
servers["yamlls"] = {
